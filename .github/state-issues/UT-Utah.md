# [UT] Utah Voter Registration Data Source Needed

🚨 Help Needed: Utah Voter Registration Data

We need help finding voter registration party data for **Utah**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `ut`
