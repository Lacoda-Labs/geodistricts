# [LA] Louisiana Voter Registration Data Source Needed

🚨 Help Needed: Louisiana Voter Registration Data

We need help finding voter registration party data for **Louisiana**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `la`
