# [VT] Vermont Voter Registration Data Source Needed

🚨 Help Needed: Vermont Voter Registration Data

We need help finding voter registration party data for **Vermont**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `vt`
