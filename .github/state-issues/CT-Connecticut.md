# [CT] Connecticut Voter Registration Data Source Needed

🚨 Help Needed: Connecticut Voter Registration Data

We need help finding voter registration party data for **Connecticut**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `ct`
