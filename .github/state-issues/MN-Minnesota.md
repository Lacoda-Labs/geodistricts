# [MN] Minnesota Voter Registration Data Source Needed

🚨 Help Needed: Minnesota Voter Registration Data

We need help finding voter registration party data for **Minnesota**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `mn`
