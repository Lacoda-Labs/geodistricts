# [MI] Michigan Voter Registration Data Source Needed

🚨 Help Needed: Michigan Voter Registration Data

We need help finding voter registration party data for **Michigan**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `mi`
