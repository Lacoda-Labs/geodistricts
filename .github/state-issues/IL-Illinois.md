# [IL] Illinois Voter Registration Data Source Needed

🚨 Help Needed: Illinois Voter Registration Data

We need help finding voter registration party data for **Illinois**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `il`
