# [GA] Georgia Voter Registration Data Source Needed

🚨 Help Needed: Georgia Voter Registration Data

We need help finding voter registration party data for **Georgia**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `ga`
