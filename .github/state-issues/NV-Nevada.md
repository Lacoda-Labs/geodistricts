# [NV] Nevada Voter Registration Data Source Needed

🚨 Help Needed: Nevada Voter Registration Data

We need help finding voter registration party data for **Nevada**!
...
**Labels**: `help-wanted`, `data`, `voter-registration`, `nv`
