...
export const ALGORITHM_VERSION = '20251203-0400'; // Fixed bridge tract infinite loop, improved swap logic for tract_DG/sibling_DG, added isolation reduction check
